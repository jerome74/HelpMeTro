...
public class VoiceListStationEvent  implements Observer  ,  PreferenceCallBack , OnInitListener
{
	ImageView imageView;
	TextView  textView;
	ProxyView proxyView;
	...
	View.OnClickListener dialogClickListener = new View.OnClickListener() 
   {
		public void onClick(View arg0) 
		{
			...
			intent.putExtra(UTIL_GEO.EXTRA_PROMPT, proxyView.getActivity().getString(R.string.rec_lable_station_list));
			intent.putExtra(UTIL_GEO.NB_TO_NOTIFY,UTIL_GEO.NB_VoiceStyle_NOTIFY);
			proxyView.getContext().startActivity(intent);
			
		}
   };

	public VoiceListStationEvent(View imageView , View textView) 
	{
		super();
	...
	public void update(Observable arg0, Object arg1) 
	{
		...
		NotifyBean.createEvent(UTIL_GEO.NB_VoiceStyle, this);
	}
                    ...
                    public void run() 
                    {
                    		...
                    		if(messaggio != null)
                    		{
                    			...
                    			else
                    			{
                    		        ...
                    		        String[] bases = r.getStringArray(R.array.stations_a);

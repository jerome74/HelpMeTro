...
import it.mygeo.project.activities.RangeStationActivity;
...
public class TextRangeStationEvent implements Observer  ,  PreferenceCallBack
{
	TextView textView;
	ProxyView proxyView;
	...
	View.OnClickListener dialogClickListener = new View.OnClickListener() 
   {
		...
		{
			Intent intent = new Intent(proxyView.getContext(), RangeStationActivity.class);
	...
	public TextRangeStationEvent(View textView) 
	{
		super();

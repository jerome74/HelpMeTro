...
public class ToggleButtonMetroB implements Observer ,  PreferenceCallBack
{
	...
	public ToggleButtonMetroB(View toggleButton) 
	{
		super();
	...
	View.OnClickListener clickListener = new View.OnClickListener() 
	   {
		public void onClick(View arg0) 
		{
				 ...
				 ToggleButton tb = (ToggleButton)proxyView.getActivity().findViewById(R.id.metroAButton);
